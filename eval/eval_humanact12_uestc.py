...
def main():
    ...
    data_loader = get_dataset_loader(name=args.dataset, batch_size=args.batch_size, num_frames=196, data_mode=args.data_mode, normalize_data=(not args.normalize_data_off))
