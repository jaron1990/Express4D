...
class TrainDecompOptions():
    def __init__(self):
        ...
        self.parser.add_argument('--fps', type=int, default=20, help='fps of the data')
        ...
        self.parser.add_argument('--flip_face_on', action="store_true", help='flip face horizontally for augmentation')
...
class TrainTexMotMatchOptions():
    def __init__(self):
        ...
        self.parser.add_argument('--dataset_name', type=str, default='t2m', help='Dataset Name')
        self.parser.add_argument('--checkpoints_dir', type=str, default='./checkpoints', help='models are saved here')
        self.parser.add_argument('--decomp_name', type=str, default="decomp_v3", help='Name of this trial')
        ...
        self.parser.add_argument('--max_epoch', type=int, default=1000, help='Training iterations')
        self.parser.add_argument('--estimator_mod', type=str, default='bigru')
        self.parser.add_argument('--feat_bias', type=float, default=5, help='Layers of GRU')
        self.parser.add_argument('--negative_margin', type=float, default=10.0)
        self.parser.add_argument('--fps', type=int, default=20, help='fps of the data')
        self.parser.add_argument('--max_motions', type=int, default=-1, help='Max number of sequences to train on')
