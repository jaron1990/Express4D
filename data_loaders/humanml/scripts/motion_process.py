...
def recover_root_rot_pos(data, hml_type=None):
    if hml_type == 'global':
        ...
        raise ValueError('Function only applicaple for None and global_root representations.')
...
def hml_to_abs_loc(motion, mean, std, joints_num):
    ...
    joints_loc = recover_from_ric(unnormed_motion, joints_num) # FIXME - not supporting global hml_type
